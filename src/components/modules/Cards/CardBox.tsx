...
const CardBox: FC<SectionCardProps> = ({ sectionTitle, buttonTitle, children, icon: Icon }) => {
    ...
    return (
        <div className='select-none p-5 neu__norm rounded-3xl overflow-hidden w-full'>
            ...
            <div className="flex items-center px-3 gap-5 w-full">
                {/* back button */}
                <button onClick={scrollBack} className="px-1 py-10 rounded-lg neu__norm">
                ...
                {/* next button */}
                <button onClick={scrollForward} className="px-1 py-10 rounded-lg  neu__norm">
